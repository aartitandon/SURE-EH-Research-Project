...
ggplot(data = aid_device_language2, aes(x = evDesc2, fill = device_cat)) + 
  ...
  scale_y_continuous(labels = function(x) paste0(x*100, "%")) + 
   labs(x = "Language", 
       y = "Percentage", 
       title = "Different Languages by Operating System in 2020-2021 (N = 67,754 clicks)") +
      scale_x_discrete(labels = c("English", "Spanish")) +
...
Growing season starts around mid-March till the end of November. This figure depicts the increase in session duration mid-year. The rise in activity at this time conveys the success of the application targeting this specific population of  farmworkers. (include one more sentence about pesticide training from Jan-March)
...
In regards to the 'Day of the Month', the usage remains relatively consistent. However, there is a spike in usage of the application each day from 12-3 PM. (include sentence about user clicks per session at end of workday)
