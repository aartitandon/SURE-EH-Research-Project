...
<img src="Subquestions_files/figure-markdown_strict/user-map-wa-1.png" width="100%" />
    ...
    wa_study_counties <- wa_county %>% 
      filter(NAME %in% c("Mason", "Chelan", "King"))
...
![](Subquestions_files/figure-markdown_strict/unnamed-chunk-1-1.png)
      ...
      geom_sf_label_repel(data = wa_study_counties, aes(label = NAME), force = 50) +
...
![](Subquestions_files/figure-markdown_strict/unnamed-chunk-1-2.png)
