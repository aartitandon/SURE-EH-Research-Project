...
###########################################################
# nb issue with PICOL product name != H&S product name
###########################################################
# TODO
...
def countAllDls(logs, ignores):
    dls = {}
    for log in logs:
        if (log['aid'] not in ignores) and (log['evType'] == 'evDownloadLabel'):
