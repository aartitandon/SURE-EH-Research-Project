...
# extract view page information of app usage
###########################################################
# TODO
...
def extract2CSV(fname):
    db = firestore.client()
    logs_ref = db.collection(u'logs').where(u'evType', u'==', u'evViewPage').where(u'ts', u'>=', u'2020-08-26').order_by(
