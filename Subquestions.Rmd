...
```{r activity-in-label-sections, echo=F, warning=F, message=F, eval=T, fig.width = 8, fig.height=8}
library(ggplot2)
library(tidyverse)
...
```{r fre-diff-links-by-language, echo=F, warning=F, message=F, eval=T, fig.width = 8, fig.height=8}
library(dplyr)
library(ggplot2)
