...
```{r creating-sessions, echo=F, eval=F}
...
```{r operating-systems, echo=F, eval=F}
...
```{r languagefrequency, warning=F, message=F, echo=F, results=F, eval=F}
...
```{r freq-of-lang-by-device, echo=F, eval=F}
...
```{r activity-in-label-sections, echo=F, warning=F, message=F, eval=T, fig.width = 12, fig.height=12}
library(ggplot2)
library(tidyverse)
...
```{r fre-diff-links-by-language, echo=F, warning=F, message=F, eval=T, fig.width = 10, fig.height=10}
library(dplyr)
library(ggplot2)
...
```{r fre-diff-links-by-language2, echo=F, warning=F, message=F, eval=T, fig.width = 10, fig.height=10}
str(evDownload.01)
