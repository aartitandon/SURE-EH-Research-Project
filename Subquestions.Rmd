...
pacman::p_load(tidyverse, utils, lubridate, readxl, vcd, kableExtra, table1, summarytools, here, maps, sf, ggmap, sp, ggthemes, ggspatial, urbnmapr, breakDown, dplyr, expm, devtools, data.table, ggplot2, car, viridis, ggExtra, tidyr)
...
```{r evStart-summary, eval=F, warning=F, message=F, echo=F, results='asis'}
...
```{r user-map-wa-allcounties, warning=F, message=F, echo=F, eval=T, out.width = "100%"}
...
```{r, warning=F, message=F, echo=F, eval=T, out.width = "100%"}
