...
```{r searchedpesticides, warning=F, message=F, echo=F, results=T, eval=T, fig.cap="Amongst 129 total pesticides in the application, Table 1 displays the top searched pesticides. 'Lorsban® Advanced' was the most popularly looked at pesticide among users from August 2020-2021." }
library("dplyr")
