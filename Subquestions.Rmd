...
```{r creating-sessions, echo=F, eval=T}
...
```{r operating-systems, echo=F, eval=T}
...
```{r languagefrequency, warning=F, message=F, echo=F, results=F, eval=T}
...
```{r device_cat_aid, echo=F, eval=T}
...
```{r freq-of-lang-by-device, echo=F, eval=T}
# Frequency of Different Languages by Device
...
```{r fre-diff-links-by-language2, echo=F, warning=F, message=F, eval=T, fig.width = 7, fig.height=7}
str(evDownload.01)
...
```{r activity-in-label-sections, echo=F, warning=F, message=F, eval=T, fig.width = 10, fig.height=10}
library(ggplot2)
library(tidyverse)
...
```{r, echo=F, warning=F, message=F, eval=T, fig.width = 17, fig.height=10}
str(evViewPage.01)
...
```{r fre-diff-links-by-language, echo=F, warning=F, message=F, eval=T, fig.width = 17, fig.height=10}
library(dplyr)
library(ggplot2)
