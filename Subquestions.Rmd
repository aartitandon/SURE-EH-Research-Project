...
```{r packages, echo=FALSE, warning=F, message=F, results=F}

if(!require(pacman)) {install.packages("pacman")}
pacman::p_load(tidyverse, utils, lubridate, readxl, vcd, kableExtra, table1, summarytools, here, maps, sf, ggmap, sp, ggthemes, ggspatial, urbnmapr, breakDown, dplyr, expm)
...
```{r user-map-wa-2, warning=F, message=F, echo=F, eval=T, out.width = "100%"}
