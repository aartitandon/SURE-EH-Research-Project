...
```{r activity-in-label-sections, echo=F, warning=F, message=F, eval=T, out.width = "75%"}
library(ggplot2)
library(tidyverse)
...
```{r fre-diff-links-by-language, echo=F, warning=F, message=F, eval=T, out.width = "75%"}
library(dplyr)
library(ggplot2)
