...
# App Use By Time
<figcaption align = "center"><b>Note: For the Time-Series Calendar HeatMaps, the shade of blue will indicate the usage on the application. If there is no blue, this means there was no application usage during that time (e.g. month, day, hour). </b></figcaption>
## Comparing User Sessions by 'Day of the Month', 'Month', and 'Activity of the User'
