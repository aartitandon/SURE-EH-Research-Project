...
pacman::p_load(tidyverse, utils, lubridate, readxl, vcd, kableExtra, table1, summarytools, here, maps, sf, ggmap, sp, ggthemes, ggspatial, urbnmapr, breakDown, dplyr, expm, devtools, data.table, ggplot2, car, viridis, ggExtra, tidyr, tigris, frequency)
...
```{r user-map-wa-kingcounty, warning=F, message=F, echo=F, eval=T, out.width = "50%"}
...
```{r user-map-wa-allcounties, echo=F, warning=F, message=F, eval=T, out.width = "50%"}
