...
```{r searchedpesticides2, fig.align='center', warning=F, message=F, echo=F, results=T, eval=T}

knitr::kable(my_table,
             caption = "Amongst 129 total pesticides in the application, Table 1 displays the top ten searched pesticides. 'Lorsban® Advanced' was the most popularly looked at pesticide among users from August 2020-2021.")
```
